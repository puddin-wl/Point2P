% run_initial_phase_generation_beam6p5x6p7
%
% Generate an initial phase using an elliptical Gaussian beam:
%   X 1/e^2 diameter = 6.5 mm
%   Y 1/e^2 diameter = 6.7 mm
...
cfg.input_1e2_diameter_x_m = 6.5e-3;
cfg.input_1e2_diameter_y_m = 6.7e-3;
...
out_dir = fullfile(cfg.output_root, 'phase0_beamX6p5mm_Y6p7mm');
