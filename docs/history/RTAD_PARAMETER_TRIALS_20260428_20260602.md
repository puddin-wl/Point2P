# RTAD/WGS 参数扫描历史（2026-04-28 至 2026-06-02）

> 本文件由原 `rtad_mraf_gs_python/README.md` 迁移而来，仅用于保存早期算法说明和参数扫描原始记录。正文中的“默认”“推荐”“最终”等措辞均属于当时语境；当前状态以 `../PROJECT_STATUS.md` 为准。
